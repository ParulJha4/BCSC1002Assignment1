...
public class Student {
    ...
    public String toString() {
        return "Name of Student: " + getNameOfTheStudent() + ", " +
                ...
                "Names of Books Issued: " + Array.toString(getNamesOfTheBooksIssuedByTheStudent()) + ".";
    }
    ...
    public boolean equals(Object o) {
        ...
        return getUniversityRollNumberOfTheStudent() == student.getUniversityRollNumberOfTheStudent() &&
                ...
                Object.equals(getNameOfTheStudent(), student.getNameOfTheStudent()) &&
                Array.equals(getNamesOfTheBooksIssuedByTheStudent(), student.getNamesOfTheBooksIssuedByTheStudent());
    }

    @Override
    public int hashCode() {
        int result = Object.hash(getNameOfTheStudent(), getUniversityRollNumberOfTheStudent(), getNumberOfBooksIssuedByTheStudent());
        result = 31 * result + Array.hashCode(getNamesOfTheBooksIssuedByTheStudent());
        return result;
    }
